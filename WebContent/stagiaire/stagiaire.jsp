...
<html>
    ...
    <div class="text-center">
    	<div class ="button">	
			<a id="button" class="btn" href="<c:url value="/voirListeQuestionnaires" />">Voir la liste des questionnaires</a>	
		</div>
		<div class ="button">	
			<a id="button" class="btn" href="<c:url value="/voirParcours" />">Voir mes parcours</a>	
		</div>
    </div>
    </body>
</html>