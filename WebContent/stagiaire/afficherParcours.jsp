    ...
    <body>    
    	<nav class="navbar">
			<div class="container-fluid">
				...
				<form class="navbar-form form_col" method = "post" action = "<c:url value="voirParcours" />">
					<div class="col-sm-6">
	    				...
	    				<div class="row bord">
							<div class="col-sm-6 row">
								<div class="col-sm-5">
									...
									<label class="lab1">Questionnaire</label><br>
								</div>
								<div class="col-sm-7">
							...
							<div class="col-sm-6 row">
								...
								<div class="col-sm-7">
									<label class="lab2"><c:out value="${parcours.getScore()}/${parcours.getReponse().size()+2}" /></label><br>
