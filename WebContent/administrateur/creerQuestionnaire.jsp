...
<html>
    ...
    <body>    
        ...
        <div class="container-fluid text-center tab-content"><br/><br/>
			<div class ="consigne">Remplir les informations concernant le questionnaire</div><br/>
			<div class ="iform">
				<fieldset>	
					<div id="iform">
           			<form class="iform"class="content" method="post" action="<c:url value="/creerQuestionnaire" />">
           				<div class ="champ">	
							<label class="lab">Sujet:</label>
							<input type="text" class="input" id="nom" name="sujet" value="" size="20" maxlength="60" />
						</div>					
						<div class ="button">	
							<button id="button" class="btn" type ="submit">Creer questionnaire</button>	
						</div>
		    		</form>
		    		</div>
               	</fieldset>
