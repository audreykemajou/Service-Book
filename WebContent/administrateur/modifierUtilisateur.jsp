...
<html>
    ...
    <body>    
        ...
        <div class="container-fluid text-center tab-content"><br/><br/>
			<div class ="consigne">Modifier les informations concernant l'utilisateur</div><br/>
			<div class ="form">
				<fieldset>	
					<div id="form">
           			<form class="form"class="content" method="post" action="<c:url value="modifierUtilisateur" ><c:param name="id" value="${utilisateur.getId()}"/></c:url>">
           				<div class ="champ">	
						...
						<div class ="button">	
							<button id="button" class="btn" type ="submit">Modifier</button>	
						</div>
		    		</form>
		    		</div>
               	</fieldset>
